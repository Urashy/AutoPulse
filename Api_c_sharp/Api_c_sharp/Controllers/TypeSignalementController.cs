...
namespace Api_c_sharp.Controllers
{
    ...
    public class TypeSignalementController (TypeSignalementManager _manager, IMapper _typeCompteMapper) : ControllerBase
    {
        ...
        [ActionName("GetById")]
        [HttpGet("{id}")]
        [ProducesResponseType(typeof(TypeSignalementDTO), StatusCodes.Status200OK)]
        ...
        [HttpGet]
        [ActionName("GetAll")]
        [ProducesResponseType(typeof(IEnumerable<TypeSignalementDTO>), StatusCodes.Status200OK)]
