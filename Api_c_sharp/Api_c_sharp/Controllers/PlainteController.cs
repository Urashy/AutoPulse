...
namespace Api_c_sharp.Controllers
{
    ...
    public class PlainteController(PlainteManager _manager, IMapper _adresseMapper) : ControllerBase
    {
        ...
        /// </summary>
        /// <param name="dto">Objet <see cref="PlainteCreateDTO"/> contenant les informations de l'adresse à créer.</param>
        /// <returns>
        /// <list type="bullet">
        ...
        /// <returns>
        /// <list type="bullet">
        /// <item><description><see cref="PlainteDTO"/> si l'adresse existe (200 OK).</description></item>
        /// <item><description><see cref="NotFoundResult"/> si aucune adresse ne correspond (404).</description></item>
        /// </list>
        /// </returns>
        [ActionName("GetById")]
