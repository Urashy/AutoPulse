...
namespace App.ControllersUnitaires.Tests
{
    ...
    public class FavoriControllerTests
    {
        ...
        public async Task PutTest()
        {
            ...
            var updated = await _manager.GetByIdAsync(_objetcommun.IdCompte, _objetcommun.IdAnnonce);
        ...
        public async Task DeleteTest()
        {
            ...
            var deleted = await _manager.GetByIdAsync(_objetcommun.IdCompte, _objetcommun.IdAnnonce);
