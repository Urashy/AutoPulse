...
namespace Api_c_sharp.ControllersUnitaires.Tests
{
    ...
    public class EtatCompteControllerTests
    {
        ...
        private EtatCompteManager _manager;
        ...
        public async Task Initialize()
        {
            ...
            _manager = new EtatCompteManager(_context);
            _controller = new EtatCompteController(_manager, _mapper);

            EtatCompte objet = new EtatCompte
            {
                IdEtatCompte = 1,
                Libelle = "Actif"
            };
            await _context.EtatComptes.AddAsync(objet);
